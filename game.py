...
player1_image = pygame.image.load('/Dokumenty/Python/games/dodge game/images/player1.png')
player2_image = pygame.image.load('/Dokumenty/Python/games/dodge game/images/player2.png')
asteroid_image = pygame.image.load('/Dokumenty/Python/games/dodge game/images/asteroid.png')
...
player1 = player1(WIDTH * 2/3, HEIGHT / 2, player1_image)
player2 = player2(WIDTH * 1/3, HEIGHT / 2, player2_image)
Players2 = False

player1.setColor(color_white)
player2.setColor(color_yellow)

enemX = enemyX(WIDTH, HEIGHT, asteroid_image)
enemY = enemyY(WIDTH, HEIGHT, asteroid_image)
...
###############################################################################################
    ...
    while len(enemyY_list) < enemyY_count and enemyY_generation == True and game_over == False:
        e = enemyY(WIDTH, HEIGHT, asteroid_image)
        collision = False
    ...
    while len(enemyX_list) < enemyX_count and enemyX_generation == True and game_over == False:
        e = enemyX(WIDTH, HEIGHT, asteroid_image)
        collision = False
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_r:
                    ...
                    pygame.display.update()
                    speed = enemX.velocity
                    player1.move_count = enemX.velocity
                    score.count = 0
                    player1.win = False
                    player2.win = False
...
##############################################
    if not menu and not game_over:
        player1.rotate(player1.angle * 90)
        player1.draw(screen)
        if Players2:
            player2.rotate(player2.angle * 90)
            player2.draw(screen)
    pygame.display.update()
    screen.fill(color_background)
